...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   it gets the Route of the current page, so we dont need to hard code the routes
1. How would you explain form validation to someone who has never programmed before?
   its a way to automate a user doing stuff on our site, so we can test to see if anything doesnt work the way we intend it to.
1. In 1-2 sentences, define end to end testing.
   end to end testing is testing every part of our site. we go through the whole process a typical user would do on our site.
